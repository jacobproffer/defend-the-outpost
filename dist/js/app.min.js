...
var hamburger=$(".hamburger"),headerHeight=$("header.main-header").outerHeight();$(window).scroll(function(){var e=$(window).scrollTop();$(".uav-view").css({transform:"scale("+(100+e/5)/100+")"})}),$('a[href*="#"]').not('[href="#"]').not('[href="#0"]').click(function(e){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var a=$(this.hash);a=a.length?a:$("[name="+this.hash.slice(1)+"]"),a.length&&(e.preventDefault(),$("html, body").animate({scrollTop:a.offset().top},1e3,function(){var e=$(a);return e.focus(),!e.is(":focus")&&(e.attr("tabindex","-1"),void e.focus())}))}}),hamburger.click(function(){$(".main-nav").toggleClass("nav-open"),$(this).toggleClass("navOpen"),$(".main-header").toggleClass("open")}),$('a[href*="#"]').click(function(){$(".main-header").hasClass("open")&&($(".main-nav").removeClass("nav-open"),$(".main-header").removeClass("open"),$(".hamburger").removeClass("navOpen"))}),$("header.main-header").headroom({offset:headerHeight,tolerance:{up:10,down:10},classes:{pinned:"pinned",unpinned:"unpinned",top:"onTop",notTop:"scrolled"}});