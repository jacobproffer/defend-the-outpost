...
$(window).scroll(function(){var a=$(window).scrollTop();$(".uav-view").css({transform:"scale("+(100+a/5)/100+")"})}),$('a[href*="#"]').not('[href="#"]').not('[href="#0"]').click(function(a){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var t=$(this.hash);t=t.length?t:$("[name="+this.hash.slice(1)+"]"),t.length&&(a.preventDefault(),$("html, body").animate({scrollTop:t.offset().top},1e3,function(){var a=$(t);return a.focus(),!a.is(":focus")&&(a.attr("tabindex","-1"),void a.focus())}))}}),$("[data-fancybox]").fancybox({caption:function(a,t){var o,n;if("image"===t.type)return o=$(this).data("caption"),n='<a href="'+t.src+'">Download image</a>',(o?o+"<br />":"")+n}});