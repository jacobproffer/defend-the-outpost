...
var scrollTopPosition=0,lastKnownScrollTopPosition=0,htmlBody=$("html, body"),hamburger=$(".hamburger"),mainHeader=$(".main-header"),headerHeight=$(".main-header").outerHeight();$(window).scroll(function(){var e=$(window).scrollTop();$(".uav-view").css({transform:"scale("+(100+e/5)/100+")"})}),$('a[href*="#"]').not('[href="#"]').not('[href="#0"]').click(function(e){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var n=$(this.hash);n=n.length?n:$("[name="+this.hash.slice(1)+"]"),n.length&&(e.preventDefault(),$("html, body").animate({scrollTop:n.offset().top},1e3,function(){var e=$(n);return e.focus(),!e.is(":focus")&&(e.attr("tabindex","-1"),void e.focus())}))}}),hamburger.click(function(){$(".main-nav").toggleClass("nav-open"),$(this).toggleClass("navOpen"),mainHeader.toggleClass("open"),htmlBody.toggleClass("body-modal-open"),$(".main-nav").hasClass("nav-open")?$("body").bind("touchmove",function(e){$(e.target).parents().hasClass("nav-open")||e.preventDefault()}):$("body").unbind("touchmove")}),$('a[href*="#"]').click(function(){$(".main-header").hasClass("open")&&($(".main-nav").removeClass("nav-open"),$(".main-header").removeClass("open"),$(".hamburger").removeClass("navOpen"))}),mainHeader.headroom({offset:headerHeight,tolerance:{up:10,down:10},classes:{pinned:"pinned",unpinned:"unpinned",top:"onTop",bottom:"onBottom",notTop:"scrolled"},onTop:function(){mainHeader.removeClass("pinned")}});