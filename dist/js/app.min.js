...
var hamburger=$(".hamburger"),headerHeight=$(".main-header").outerHeight();$(window).scroll(function(){var e=$(window).scrollTop();$(".uav-view").css({transform:"scale("+(100+e/5)/100+")"})}),$('a[href*="#"]').not('[href="#"]').not('[href="#0"]').click(function(e){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var n=$(this.hash);n=n.length?n:$("[name="+this.hash.slice(1)+"]"),n.length&&(e.preventDefault(),$("html, body").animate({scrollTop:n.offset().top},1e3,function(){var e=$(n);return e.focus(),!e.is(":focus")&&(e.attr("tabindex","-1"),void e.focus())}))}}),hamburger.click(function(){$(".main-nav").toggleClass("nav-open"),$(this).toggleClass("navOpen"),$(".main-header").toggleClass("open")}),$('a[href*="#"]').click(function(){$(".main-header").hasClass("open")&&($(".main-nav").removeClass("nav-open"),$(".main-header").removeClass("open"),$(".hamburger").removeClass("navOpen"))}),$(".main-header").headroom({offset:headerHeight,tolerance:{up:10,down:10},classes:{pinned:"pinned",unpinned:"unpinned",top:"onTop",bottom:"onBottom",notTop:"scrolled"},onTop:function(){$(".main-header").removeClass("pinned")}});