...
var body=$("html, body"),hamburger=$(".hamburger"),mainHeader=$(".main-header"),mainNav=$(".main-nav"),headerHeight=$(".main-header").outerHeight();$(window).scroll(function(){var e=$(window).scrollTop();$(".uav-view").css({transform:"scale("+(100+e/5)/100+")"})}),hamburger.click(function(){mainNav.toggleClass("nav-open"),$(this).toggleClass("navOpen"),mainHeader.toggleClass("open"),body.toggleClass("body-modal-open"),body.toggleClass("disable-scrolling")}),$('a[href*="#"]').click(function(){mainNav.removeClass("nav-open"),mainHeader.removeClass("open"),hamburger.removeClass("navOpen"),body.removeClass("body-modal-open"),body.removeClass("disable-scrolling")}),$('a[href*="#"]').not('[href="#"]').not('[href="#0"]').click(function(e){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var a=$(this.hash);a=a.length?a:$("[name="+this.hash.slice(1)+"]"),a.length&&(e.preventDefault(),$("html, body").animate({scrollTop:a.offset().top},1e3,function(){var e=$(a);return e.focus(),!e.is(":focus")&&(e.attr("tabindex","-1"),void e.focus())}))}}),mainHeader.headroom({offset:headerHeight,tolerance:{up:10,down:10},classes:{pinned:"pinned",unpinned:"unpinned",top:"onTop",bottom:"onBottom",notTop:"scrolled"},onTop:function(){mainHeader.removeClass("pinned")}}),document.ontouchmove=function(e){for(var a=!0,o=e.target;null!==o;){if(o.classList&&o.classList.contains("disable-scrolling")){a=!1;break}o=o.parentNode}a||e.preventDefault()};