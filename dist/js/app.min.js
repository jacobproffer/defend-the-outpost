...
var scrollTopPosition=0,lastKnownScrollTopPosition=0,htmlBody=$("html, body"),hamburger=$(".hamburger"),mainHeader=$(".main-header"),headerHeight=$(".main-header").outerHeight();$(window).scroll(function(){var o=$(window).scrollTop();$(".uav-view").css({transform:"scale("+(100+o/5)/100+")"})}),$('a[href*="#"]').not('[href="#"]').not('[href="#0"]').click(function(o){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var n=$(this.hash);n=n.length?n:$("[name="+this.hash.slice(1)+"]"),n.length&&(o.preventDefault(),$("html, body").animate({scrollTop:n.offset().top},1e3,function(){var o=$(n);return o.focus(),!o.is(":focus")&&(o.attr("tabindex","-1"),void o.focus())}))}}),hamburger.click(function(){$(".main-nav").toggleClass("nav-open"),$(this).toggleClass("navOpen"),mainHeader.toggleClass("open"),htmlBody.toggleClass("body-modal-open")}),navigator.userAgent.match(/iPhone|iPad|iPod/i)&&(htmlBody.addClass("platform-ios"),$(window).scroll(function(){scrollTopPosition=$(document).scrollTop()}),$(".main-nav").hasClass("nav-open")?($("body").css("top",scrollTopPosition*-1),lastKnownScrollTopPosition=scrollTopPosition):$("body").scrollTop(lastKnownScrollTopPosition)),$('a[href*="#"]').click(function(){$(".main-header").hasClass("open")&&($(".main-nav").removeClass("nav-open"),$(".main-header").removeClass("open"),$(".hamburger").removeClass("navOpen"))}),mainHeader.headroom({offset:headerHeight,tolerance:{up:10,down:10},classes:{pinned:"pinned",unpinned:"unpinned",top:"onTop",bottom:"onBottom",notTop:"scrolled"},onTop:function(){mainHeader.removeClass("pinned")}});